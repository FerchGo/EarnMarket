           ...
           <main className='changeame mx-auto max-w-4xl px-6 md:px-8 pt-4 z-10 min-w-0 w-full'>
             ...
             <p>
              The main object for this section is to show you all my professional background and the different sort of experiences I have had in the past, I hope you enjoy it. 
               <a
                 target='_blank'
                 rel='noreferrer'
                 href='https://co.linkedin.com/in/luis-fernando-torres-g%C3%B3mez-5820a0118' > It's a plesure to tell you a little bit about myself, you can click on here to find out more!!</a>
             ...
             <div className='grid grid-cols-1 gap-3 my-12'>
               ...
               <div className='flex items-center space-x-4'>
                 ...
                 <div>
                   <div className='my-0 font-small dark:text-white'>
                     HTML / Css / Sass / Javascript / ESC6 / Frameworks as Bootstrap or tailwind
                   </div>
                 </div>
               </div>
               <div className='flex items-center space-x-4'>
             ...
             <p>
               With a background in the supply chain and logistic industry, I've worked with the biggest companies in the world, such as Johnson & Johnson Medical Devices and With the largest Ecommerce in Latin America. 
               <a
                 target='_blank'
                 rel='noreferrer'
                 href='https://www.jnj.com/innovation/how-johnson-johnsons-supply-chain-made-strides-in-2016'
                 > JnJ Medical Supply chain </a>
               - On the other hand as I got my Developer certification I've been working in the ecommerce sector, Handling different activities which are related to managing platforms, such as <code>Vitex,</code> <code>Shopify,</code> Also related to build from scratch websites with all the frontend technologies as HTML css javascript and making it work in a react surround.
               <a
                 target='_blank'
                 rel='noreferrer'
                 href='https://devf.la/'
             ...
             <hr />
             <p>
               With all the years that I've got working and studying I have learnt how to implement these two pathways, software skills always will help you improve different processes and make your life easier, In adition the ecommerce is starting to be a big part of the world economy, so it's important to know how to handle it and build or modify each process in the web. 
             </p>
